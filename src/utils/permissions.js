...
export const allPermissions = [
    ...
    "permissions": [
      ...
      },
      {
        ...
        "children": [
          ...
          {
            "key": "REQUEST-STAFF-SHIFT-SCHEDULE",
            "label": "Request Staff Shift Schedule"
          },
          {
          ...
          {
            "key": "REQUEST-AVAILABILTY-INDIVIDUAL",
            "label": "Request Availability- Individual"
          },
          {
            "key": "REQUEST-AVAILABILITY-ALL",
            "label": "Request Availability- All"
          },
          {
      ...
      },
      {
        ...
        "children": [
          ...
          {
            "key": "REQUEST-DEPARTMENTS",
            "label": "Request Departments"
          },
          {
      ...
      },
      {
        ...
        "children": [
          ...
          {
            "key": "REQUEST-SECURITY-ROLES",
            "label": "Request Security Roles"
          },
          {
      ...
      },
      {
        ...
        "children": [
          ...
          {
            "key": "REQUEST-COMMISSION-GROUP",
            "label": "Request Commission Group"
          },
          {
  ...
  },
  {
    ...
    "permissions": [
      ...
      {
        "key": "REQUEST-MEMBERSHIP-TYPES",
        "label": "Request Membership Type"
      },
      {
      ...
      {
        "key": "REQUEST-SERVICE-ACCESS",
        "label": "Request Service Access"
      },
      {
        "key": "REQUEST-ENTRY-ACCESS",
        "label": "Request Entry Access"
      },
      {
      ...
      {
        "key": "CREATE-MEMBERSHIP-TYPES",
        "label": "Create Membership Types"
      },
      {
        "key": "DELETE-MEMBERSHIP-TYPES",
        "label": "Delete Membership Types"
      },
      {
        "key": "REQUEST-FREEZE-POLICY",
        "label": "Request Freeze Policy"
      },
      {
        "key": "FREEZE-POLICY",
        "label": "Freeze Policy"
      ...
      {
        "key": "EDIT-FREEZE-POLICY",
        "label": "Edit Freeze Policy"
      },
      {
        "key": "ADD-FREEZE-POLICY",
        "label": "Add Freeze Policy"
      },
      {
        "key": "OVERRIDE-FREEZE-POLICY",
        "label": "Override Freeze Policy"
      }
    ]
  },
  {
    ...
    "permissions": [
      ...
      },
      {
        ...
        "children": [
          ...
          {
            "key": "REQUEST-SALE-PRICE",
            "label": "Request sale price"
          },
          {
  ...
  },
  {
    ...
    "permissions": [
      {
        "key": "REQUEST-BRANDING-COLORS-LOGOS",
        "label": "Request Branding Colors/logos "
      },
      {
      ...
      {
        "key": "REQUEST-TAB-LAYOUTS-DEPARTMENTS",
        "label": "Request tab layouts-Department"
      },
      {
      ...
      {
        "key": "REQUEST-TAB-LAYOUTS-ALL",
        "label": "Request tab layouts-All "
      },
      {
  ...
  },
  {
    ...
    "permissions": [
      {
        "key": "REQUEST-ALERT-TYPES",
        "label": "Request Alert Types"
      },
      {
  ...
  },
  {
    ...
    "permissions": [
      {
        "key": "VIEW-ASSESSED-FEES",
        "label": "View Assessed fees"
      },
      {
        "key": "CREATE-ASSESSED-FEES",
        "label": "Create Assessed fees"
      },
      {
        "key": "EDIT-ASSESSED-FEES",
        "label": "Edit Assessed fees"
      },
      {
        "key": "VIEW-AGREEMENT-TEMPLATES",
        "label": "View Agreement Templates"
      },
      {
        "key": "CREATE-AGREEMENT-TEMPLATES",
        "label": "Create Agreement Templates"
      },
      {
        "key": "EDIT-AGREEMENT-TEMPLATES",
        "label": "Edit Agreement Templates"
      },
      {
        "key": "DELETE-AGREEMENT-TEMPLATES",
        "label": "Delete Agreement Templates"
      },
      {
        "key": "REQUEST-PAYMENT-PLANS-TYPE",
        "label": "Request Payment Plans- By Type"
      },
      {
        "key": "CREATE-NEW-PAYMENT-PLANS-TYPE",
        "label": "Create new Payment Plans – By Type "
      },
      {
        "key": "COPY-PAYMENT-PLANS-TYPE",
        "label": "Copy Payment Plans -By Type "
      },
      {
        "key": "EDIT-PAYMENT-PLANS-TYPE",
        "label": "Edit Payment Plans - By Type "
      },
      {
        "key": "VIEW-AGREEMENT-PROMOTIONS",
        "label": "View Agreement Promotions"
      },
      {
        "key": "CREATE-AGREEMENT-PROMOTIONS",
        "label": "Create Agreement Promotions"
      },
      {
        "key": "EDIT-AGREEMENT-PROMOTIONS",
        "label": "Edit Agreement Promotions"
      },
      {
        "key": "DELETE-AGREEMENT-PROMOTIONS",
        "label": "Delete Agreement Promotions"
      }
    ]
  },
  {
    ...
    "permissions": [
      ...
      {
        "key": "VIEW-ASSIGNED-CLIENTS-ONLY",
        "label": "View Assigned Clients Only"
      },
      {
        "key": "QUICK-ENROLL",
        "label": "Quick Enroll"
      ...
      {
        "key": "REQUEST-PERSONAL-INFORMATION",
        "label": "Request Personal Information Edit"
      },
      {
        "key": "EDIT-MEMBERSHIP-INFO",
        "label": "Edit Membership info"
      },
      {
        "key": "EDIT-ACCESS-CODE",
      ...
      {
        "key": "EDIT-PAYMENT-METHODS",
        "label": "Edit Payment Methods"
      },
      {
        "key": "CREATE-NEW-PAYMENT-METHOD",
      ...
      {
        "key": "REQUEST-ALERTS",
        "label": "Request Alert Edit"
      },
      {
        "key": "VIEW-BILLING-HISTORY",
        "label": "View Billing History"
      },
      {
        "key": "VIEW-CHECK-INS-HISTORY",
        "label": "View Check ins history"
      },
      {
        "key": "VIEW-NOTES",
        "label": "View Notes"
  ...
  },
  {
    ...
    "permissions": [
      ...
      {
        "key": "EDIT-CLIENT-ALERTS",
        "label": "Edit client alerts"
      },
      {
        "key": "REQUEST-CLIENT-ALERTS",
        "label": "Request client alerts"
      },
      {
        "key": "REQUEST-TASKS",
        "label": "Request task"
      ...
      {
        "key": "DEDUCT-SERVICE-FROM-CHECK-IN",
        "label": "Deduct Service from check-in"
      }
    ]
  },
  {
    ...
    "permissions": [
      ...
      },
      {
        ...
        "label": "Create Resurce Type"
      },
      {
        "key": "EDIT-RESOURCE-TYPE",
      ...
      },
      {
        ...
        "children": [
          ...
          {
            "key": "REQUEST-RESOURCE-RESERVES",
            "label": "Request resource Reserves"
          },
          {
  ...
  },
  {
    ...
    "permissions": [
      {
        "key": "REQUEST-EVENT-CATEGORIES",
        "label": "Request Event Categories"
      },
      {
        "key": "EDIT-EVENT-CATEGORIES",
        "label": "Edit Event Categories"
      },
      {
        "key": "CREATE-EVENT-CATEGORIES",
        "label": "Create Event Categories"
      },
      {
        "key": "DELETE-EVENT-CATEGORIES",
      ...
      {
        "key": "VIEW-LOCATION-TYPE",
        "label": "View Location Type"
      },
      {
        "key": "CREATE-LOCATION-TYPE",
      ...
      {
        "key": "DELETE-LOCATION-TYPE",
        "label": "Delete Location Type"
      },
      {
        "key": "VIEW-LOCATIONS",
  ...
  },
  {
    ...
    "permissions": [
      {
        "key": "VIEW-ALL-SCHEDULE",
        "label": "View all schedule"
      },
      {
        "key": "VIEW-ONLY-INDIVIDUAL-SCHEDULE",
        "label": "View only individual’s schedule"
      },
      {
      ...
      {
        "key": "SCHEDULE-CLASSES",
        "label": "Schedule Classes"
      },
      {
        "key": "REQUEST-SCHEDULE-CLASS",
        "label": "Request schedule class"
      },
      {
        "key": "EDIT-INSTRUCTOR-CLASSES",
        "label": "Edit Instructor Classes"
      },
      {
        "key": "EDIT-INSTRUCTOR-EVENTS",
        "label": "Edit Instructor Events"
      },
      {
        "key": "REQUEST-INSTRUCTOR-CLASSES",
        "label": "Request Instructor Classes"
      },
      {
        "key": "REQUEST-INSTRUCTOR-EVENTS",
        "label": "Request Instructor Events"
      },
      {
        "key": "EDIT-SCHEDULED-CLASSES",
        "label": "Edit scheduled Classes"
      },
      {
        "key": "EDIT-SCHEDULED-EVENTS",
        "label": "Edit Scheduled Events"
      },
      {
        "key": "REQUEST-CLASSES",
      ...
      {
        "key": "EDIT-COMPLETE-EVENT",
        "label": "Edit Completed Event"
      },
      {
        "key": "REQUEST-COMPLETED-EVENT",
        "label": "Request completed event"
      },
      {
        "key": "EDIT-PAST-EVENT",
        "label": "Edit Past Event"
      },
      {
        "key": "REQUEST-PAST-EVENT",
        "label": "Request past event"
      },
      {
        "key": "CANCEL-EVENT-OUTSIDE",
        "label": "Cancel Event outside of cancellation window "
      },
      {
        "key": "REQUEST-CANCEL-EVENT-OUTSIDE",
        "label": "Request Cancel event outside of cancellation window"
      }
    ]
  }
];
